...
class DyndnsStack(cdk.Stack):
    ...
    def __init__(self, scope: cdk.App, construct_id: str, **kwargs) -> None:
        ...
        # Suppress CDK-Nag errors for the log retention custom resource Lambda
        # (auto-generated by CDK when log_retention is set)
        NagSuppressions.add_stack_suppressions(
            self,
            suppressions=[
                NagPackSuppression(
                    id="AwsSolutions-IAM4",
                    reason="Log retention custom resource Lambda uses AWS managed policy "
                           "AWSLambdaBasicExecutionRole, which is required by CDK internals.",
                    applies_to=[
                ...
                NagPackSuppression(
                    id="AwsSolutions-IAM5",
                    reason="Log retention custom resource Lambda requires wildcard permissions "
                           "for logs:PutRetentionPolicy and logs:DeleteRetentionPolicy.",
                    applies_to=[
                        "Resource::*",
                    ],
                ),
